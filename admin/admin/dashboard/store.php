...
if(isset($_POST['tambah'])){
    ...
    $query = mysqli_query($koneksi, "INSERT INTO tb_items VALUES(null,'$tujuan_wisata','$jmlh_hari','$jam_berangkat','$jam_tiba','$transportasi','$penginapan','$restoran','$harga','$deskripsi')");
